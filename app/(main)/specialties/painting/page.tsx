...
export const metadata: Metadata = {
  title: 'Painting — CF Design',
  description: 'Interior and exterior painting — prep, prime, and finish. By CF Design in Palo Alto.',
}
...
export default function PaintingPage() {
  return (
    <SpecialtyLayout frontmatter={frontmatter} currentHref="/specialties/painting">
      ...
      <p className="text-lg md:text-xl text-arch-charcoal/80 leading-relaxed font-light mb-6">
        We&apos;re putting together examples of our painting work. In the meantime, feel free to reach out — we&apos;d love to hear about your project.
      </p>
    </SpecialtyLayout>
  )
}
