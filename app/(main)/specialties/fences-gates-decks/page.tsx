...
export const metadata: Metadata = {
  title: 'Fences, Gates & Decks — CF Design',
  description: 'Custom fences, gates, and decks in redwood, cedar, and composite — by CF Design in Palo Alto.',
}
...
export default function FencesGatesDecksPage() {
  return (
    <SpecialtyLayout frontmatter={frontmatter} currentHref="/specialties/fences-gates-decks">
      ...
      <p className="text-lg md:text-xl text-arch-charcoal/80 leading-relaxed font-light mb-6">
        We&apos;re putting together examples of our fence, gate, and deck work. In the meantime, feel free to reach out — we&apos;d love to hear about your project.
      </p>
    </SpecialtyLayout>
  )
}
