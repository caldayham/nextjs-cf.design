...
export const metadata: Metadata = {
  title: 'Shed Renovation — CF Design',
  description: 'Complete shed cleanouts, repairs, and renovations — including critter-infested spaces. By CF Design in Palo Alto.',
}
...
export default function ShedRenovationPage() {
  return (
    <SpecialtyLayout frontmatter={frontmatter} currentHref="/specialties/shed-renovation">
      ...
      <p className="text-lg md:text-xl text-arch-charcoal/80 leading-relaxed font-light mb-6">
        We&apos;re putting together examples of our shed renovation work. In the meantime, feel free to reach out — we&apos;d love to hear about your project.
      </p>
    </SpecialtyLayout>
  )
}
