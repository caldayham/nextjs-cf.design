...
export const metadata: Metadata = {
  title: 'Landscape Design — CF Design',
  description: 'Thoughtful landscape design that balances beauty and function — by CF Design in Palo Alto.',
}
...
export default function LandscapeDesignPage() {
  return (
    <SpecialtyLayout frontmatter={frontmatter} currentHref="/specialties/landscape-design">
      ...
      <p className="text-lg md:text-xl text-arch-charcoal/80 leading-relaxed font-light mb-6">
        We&apos;re putting together examples of our landscape design work. In the meantime, feel free to reach out — we&apos;d love to hear about your project.
      </p>
    </SpecialtyLayout>
  )
}
