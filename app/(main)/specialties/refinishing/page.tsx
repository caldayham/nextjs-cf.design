...
export const metadata: Metadata = {
  title: 'Refinishing — CF Design',
  description: 'Bringing worn surfaces back to life — wood, metal, and more. By CF Design in Palo Alto.',
}
...
export default function RefinishingPage() {
  return (
    <SpecialtyLayout frontmatter={frontmatter} currentHref="/specialties/refinishing">
      ...
      <p className="text-lg md:text-xl text-arch-charcoal/80 leading-relaxed font-light mb-6">
        We&apos;re putting together examples of our refinishing work. In the meantime, feel free to reach out — we&apos;d love to hear about your project.
      </p>
    </SpecialtyLayout>
  )
}
