...
export const metadata: Metadata = {
  title: 'Squirrel & Rat Excluders — CF Design',
  description: 'Humane exclusion solutions to keep critters out for good — by CF Design in Palo Alto.',
}
...
export default function SquirrelRatExcludersPage() {
  return (
    <SpecialtyLayout frontmatter={frontmatter} currentHref="/specialties/squirrel-rat-excluders">
      ...
      <p className="text-lg md:text-xl text-arch-charcoal/80 leading-relaxed font-light mb-6">
        We&apos;re putting together examples of our critter exclusion work. In the meantime, feel free to reach out — we&apos;d love to hear about your project.
      </p>
    </SpecialtyLayout>
  )
}
